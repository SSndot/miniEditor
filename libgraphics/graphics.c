...
#define GWClassName "Magic Edit"
#define DefaultFont "System"
HFONT newFont, oldFont;
double magicX=0, iVscrollPos=0;
...
static string windowTitle = "Magic Edit";
...
/*    RegisterWindowClass();*/
    ...
    style = WS_VSCROLL | WS_CAPTION | WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX | WS_MAXIMIZEBOX & ~(WS_MINIMIZEBOX | WS_MAXIMIZEBOX);
    g_keyboard = NULL;
	g_mouse = NULL;
	g_timer = NULL;
    ...
    wndcls.lpszClassName = "Magic Edit";
...
static void DisplayText(double x, double y, string text)
{
	...
	//SelectObject(osdc, newFont);
    if (IsEdit == 1) {
    	//RowPitch=0.03;
        SelectObject(osdc, GetStockObject(SYSTEM_FIXED_FONT));
    }
...
static void InitColors(void)
{
    ...
    DefineColor("Æ·À¶",  0,0,.54);
    DefineColor("Ä¨²èÄÌËª", 0xb8 / 256.0, 0xd3 / 256.0, 0x8f / 256.0);
    DefineColor("Âí¿¨Áú·Û", 0xf1 / 256.0, 0xb8 / 256.0, 0xf1 / 256.0);
    DefineColor("ÐÓÈÊ±ý×Ï", 0xd9 / 256.0, 0xb8 / 256.0, 0xf1 / 256.0);
    DefineColor("ÐÓÈÊ±ý³È", 0xf1 / 256.0, 0xcc / 256.0, 0xb8 / 256.0);
    DefineColor("ÐÓÈÊ±ýº£ÑóÀ¶", 0xb8 / 256.0, 0xf1 / 256.0, 0xed / 256.0);
    DefineColor("ÐÓÈÊ±ýÂÌ", 0xb8 / 256.0, 0xf1 / 256.0, 0xcc / 256.0);
    DefineColor("´óÇÉ¿ËÁ¦ÐÓÈÊ±ý", 0xae / 256.0, 0x71 / 256.0, 0x6e / 256.0);
    DefineColor("Âí¿¨Áú²ÝÝ®ÄÌËª", 0xf1 / 256.0, 0x70 / 256.0, 0x7d / 256.0);
    DefineColor("Âí¿¨Áú»ù¶û", 0xef / 256.0, 0x57 / 256.0, 0x67 / 256.0);
    DefineColor("Ó£ÌÒÉ«", 0xac / 256.0, 0x5e / 256.0, 0x74 / 256.0);
    DefineColor("Âí¿¨ÁúÃµ¹å·Ûºì", 0xf1 / 256.0, 0x53 / 256.0, 0x69 / 256.0);
    DefineColor("»ÒÀ¶", 0x8b / 256.0, 0x91 / 256.0, 0xab / 256.0);
}
